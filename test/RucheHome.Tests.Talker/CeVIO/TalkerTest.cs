...
using RucheHome.Talker.CeVIO;
using Ce = RucheHome.Talker.CeVIO;

namespace RucheHome.Tests.Talker.CeVIO
{
    /// <summary>
    /// <see cref="Ce.Talker"/> クラスのテストクラス。
    /// </summary>
    [TestClass]
    public class TalkerTest : ProcessTalkerTestBase<Ce.Talker>
    {
        /// <summary>
        /// テスト用の Talker インスタンスを取得または設定する。
        /// </summary>
        private static Ce.Talker TestTalker { get; set; } = null;
        ...
        {
            // Talker 作成
            TestTalker = new Ce.Talker { CastSpeechInputRow = CastSpeechInputRow.Current };
        ...
        [TestMethod]
        [TestCategory(nameof(CeVIO) + @"." + nameof(Ce.Talker))]
        ...
        protected override Ce.Talker GetTalkerImpl() => TestTalker;
